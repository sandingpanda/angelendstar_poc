...
const char* HeroBulletSecondary::SPRITE_PATH = "./weapon2.bmp";

HeroBulletSecondary::HeroBulletSecondary()
{
...
void HeroBulletSecondary::think(Entity* $entity)
{
...
void HeroBulletSecondary::die()
{
	delete this;
}

void HeroBulletSecondary::fire()
{
